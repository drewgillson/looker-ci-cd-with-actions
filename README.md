...
## Setup Instructions
1. First, fork this repository and check it out to your local computer, then edit `variables.tf` to set your own Looker license key and technical contact email. You must accept the EULA for your license at https://download.looker.com/validate first.
